...
deterministic post-processing trimmed the result to 2172x139 and baked a 129 px
right-edge alpha handoff. The final asset has transparent corners and is loaded
only by `town-benchmark-v1`.
