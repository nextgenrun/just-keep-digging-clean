...
export class NPCManager {
  ...
  createNPCs() {
    ...
    for (const npc of this.npcDefs) {
      ...
      const sprite = useIdleVideo
        ...
        : this.scene.add.sprite(pos.x, pos.y, motion?.textureKey || npc.assetKey);
  ...
  getActivityHealthSnapshot() {
    return { ...this.activitySystem.getHealthSnapshot(), motion: this.motionSystem?.getHealthSnapshot() };
  }
