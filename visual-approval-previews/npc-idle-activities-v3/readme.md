...
## Production direction if approved later
...
and reserve player reactions for proximity or interaction. Half-steps are safe
only inside tiny authored zones with a guaranteed return to the original anchor.
