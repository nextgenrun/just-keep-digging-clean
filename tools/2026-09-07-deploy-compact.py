...
PACKAGE = ROOT / 'dist-compact'
EVIDENCE = ROOT / '.tmp' / 'compact-production-deploy'
BUILD = 'b81aff017f80'
SSH = ['ssh', '-F', r'C:\Users\Mila\.ssh\config', '-o', 'BatchMode=yes',
       '-o', 'StrictHostKeyChecking=yes', '-o', 'ConnectTimeout=15',
       '-o', 'ServerAliveInterval=30', 'cline-local']
REMOTE = (ROOT / 'tools/2026-09-07-compact-remote.py').read_text()
...
def prepare():
    ...
    if total != 4_642_260_921 or len(expected) != 8262:
