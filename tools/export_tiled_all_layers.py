...
SOURCE_TMX = ROOT / "exports" / "dig-game-world-edit-v-7-29-06-2026-;layered.tmx"
...
def format_bg_objects_js(map_meta: dict, layer_objects: list[dict]) -> str:
    ...
    lines.append(f"// Source: dig-game-world-edit-v-7-29-06-2026-;layered.tmx")
    ...
    lines.append(f"  source: \"exports/dig-game-world-edit-v-7-29-06-2026-;layered.tmx\",")
    lines.append(
        "  map: Object.freeze({ "
...
// Source: exports/dig-game-world-edit-v-7-29-06-2026-;layered.tmx
