...
PACKAGE = ROOT / 'dist-startup-motion-fixed-20260908'
EVIDENCE = ROOT / '.tmp' / 'startup-motion-production-deploy-20260908'
BUILD = '35b25aa356da'
SSH = ['ssh', '-F', r'C:\Users\Mila\.ssh\config', '-o', 'BatchMode=yes',
       '-o', 'StrictHostKeyChecking=yes', '-o', 'ConnectTimeout=15',
       '-o', 'ServerAliveInterval=30', 'cline-local']
REMOTE = (ROOT / 'tools/2026-09-08-startup-motion-remote.py').read_text()
...
def prepare():
    ...
    if total != 4_824_482_126 or len(expected) != 8510:
