"""Build the production Heavenblocks v2 modular sprite library."""
...
def main() -> None:
    ...
    manifest = write_manifest([*sprite_paths, contact_sheet])
    print(f"Built {len(sprite_paths)} modular sprites")
    print("Built 0 region-wide backgrounds")
