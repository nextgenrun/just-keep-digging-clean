...
2026-09-10: BrandLogoView keeps the authored dark silhouette and contour static beneath the full-color animation to block scenic alpha leakage. Static/error fallbacks restore original poster color.
