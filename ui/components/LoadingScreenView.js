...
// These six approved menu backgrounds are tracked runtime assets. Do not route
// production loading through the untracked pallet export that originally
// supplied them; isolated worktrees and clean clones must resolve the same art.
