...
export const TILE_HEALTH_CONFIG = Object.freeze({
  tileHealth: {
    ...
    [TILE_TYPES.CLOUDSTONE]: { min: 900, max: 1200 },
    [TILE_TYPES.STORMGLASS]: { min: 1450, max: 1900 },
    [TILE_TYPES.HALOSTONE]: { min: 1800, max: 2300 },
    [TILE_TYPES.LUMENITE]: { min: 2600, max: 3400 },
    [TILE_TYPES.CINDERSTONE]: { min: 3600, max: 4700 },
    [TILE_TYPES.HELLGLASS]: { min: 5200, max: 6800 },
    [TILE_TYPES.HEAVEN_BARRIER]: { min: 999999999, max: 999999999 },
