...
const clip = ({
  ...
  originY, markerGroup, sourceAction,
}) => Object.freeze({
  id,
...
const clips = Object.freeze({
  ...
  jabElbow: clip({ id: "jab-elbow", fileName: "survival-character-mixamo-v3-dig-side-jab-elbow-sheet.png", from: 1, to: 28, contactFrame: 20, contactSequenceIndex: 19, originY: 911 / 1024, markerGroup: "hands", sourceAction: "mixamo-jab-to-elbow-combo" }),
  lowKick: clip({ id: "low-kick", fileName: "survival-character-mixamo-v3-dig-side-low-kick-sheet.png", from: 2, to: 16, contactFrame: 8, contactSequenceIndex: 6, originY: 908 / 1024, markerGroup: "feet", sourceAction: "mixamo-mma-low-kick" }),
  ...
  elbowUppercut: clip({ id: "elbow-uppercut", fileName: "survival-character-mixamo-v3-dig-side-elbow-uppercut-sheet.png", from: 1, to: 26, contactFrame: 22, contactSequenceIndex: 21, originY: 913 / 1024, markerGroup: "hands", sourceAction: "mixamo-elbow-uppercut-combo" }),
  singleElbow: clip({ id: "single-elbow", fileName: "survival-character-mixamo-v3-dig-side-single-elbow-sheet.png", from: 3, to: 13, contactFrame: 10, contactSequenceIndex: 7, originY: 924 / 1024, markerGroup: "hands", sourceAction: "mixamo-male-elbow-punch" }),
