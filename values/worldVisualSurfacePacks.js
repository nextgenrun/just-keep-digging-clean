...
const TOWN_BENCHMARK_V1 = Object.freeze({
  ...
  floor: Object.freeze({
    asset: asset(
      "world-visual-surface-pack-town-square-slate-v1",
      "sprites/backgrounds/start-zone-scenic-v1/town-square-slate-facade-v1.png"
    ),
    expectedSource: Object.freeze({ width: 2172, height: 139 }),
    sourceRect: Object.freeze({ x: 0, y: 0, width: 2172, height: 139 }),
    surfaceOffsetSourcePx: 2,
    frameName: "world-visual-surface-pack-town-square-slate-v1-floor",
    depth: 2.3,
    effectDepthStep: 0.005,
