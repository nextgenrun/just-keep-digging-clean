...
import { BAKED_STAR_ATLASES, BAKED_CELESTIAL_ASSETS } from "./bakedCelestialUi.js";
...
export const STAR_IDENTITY_LIBRARY_CONFIG = Object.freeze({
  ...
  inventory: Object.freeze({
    foundation: asset(
      "star-codex-foundation-baked-v1",
      "sprites/UI/baked-copy-v1/star-codex-v2.png",
    ),
    emptyFoundation: asset("star-codex-empty-baked-v1", "sprites/UI/baked-copy-v1/star-codex-empty.png"),
    bakedCopy: true,
    copy: Object.freeze({
      title: "STAR CODEX",
      tabLabel: "STAR CODEX",
      subtitle: "250 Star identities • collected Stars are revealed; unknowns stay hidden",
      selectHint: "SELECT A STAR",
      found: "FOUND",
      collected: "COLLECTED",
      emptyTitle: "NO STAR FOUND",
      emptyBody: "Mine a Star Block of this rarity to reveal its identity here.",
      colour: "COLOUR",
      hiddenHint: "UNKNOWN IDENTITIES STAY HIDDEN",
      ...
      pageLabel: "PAGE",
      navigationHint: "ARROWS  •  Q / E",
      emptyNavigationHint: "MINE A STAR BLOCK",
    }),
    appearance: Object.freeze({
      focus: "#79D7EE",
      focusNumber: 0x79D7EE,
      title: "#F3F6F8",
      body: "#C5CDD3",
      muted: "#87949D",
      shadow: "#020405",
    ...
    layout: Object.freeze({
      sourceWidthPx: 1739,
      sourceHeightPx: 904,
      aspectRatio: 1739 / 904,
      maximumWidthPx: 900,
      rarityTabCentersXPx: Object.freeze([179, 450, 713, 1009, 1277, 1544]),
      rarityTabCenterYPx: 101,
      rarityCountCenterYPx: 118,
      rarityTabHitWidthPx: 232,
      rarityTabHitHeightPx: 76,
      rarityLabelFontSizePx: 13,
      selectorCentersXPx: Object.freeze([171, 366, 558, 754]),
      selectorCentersYPx: Object.freeze([240, 426, 612]),
      selectorImageSizePx: 132,
      selectorHitSizePx: 152,
      selectorLabelOffsetYPx: 94,
      selectorLabelFontSizePx: 10,
      selectorsPerPage: 12,
      ...
      pageHitSizePx: 138,
      pageLabelOffsetYPx: -10,
      pageLabelWidthPx: 320,
      pageHintOffsetYPx: 15,
      pageLabelFontSizePx: 11,
      navigationHintFontSizePx: 11,
      previewCenterXPx: 1282,
      previewCenterYPx: 287,
      previewImageSizePx: 256,
      previewBadgeXPx: 1580,
      previewBadgeYPx: 326,
      ...
      selectedRingWidthPx: 3,
      selectedScale: 1,
      idleAlpha: 0.84,
      selectedAlpha: 1,
      rarityIdleAlpha: 0.86,
      selectorLabelIdleAlpha: 0.92,
...
export function getStarIdentityPreloadAssets(
  ...
  return Object.freeze([
    ...
    config.inventory.emptyFoundation,
    BAKED_CELESTIAL_ASSETS.labels,
    ...BAKED_STAR_ATLASES,
  ]);
}
