...
export const UPGRADES = Object.freeze({
  ...
  quickslashAbility: {
    ...
    category: UPGRADE_CATEGORIES.SPECIAL,
    name: "Quick Slash",
    description: "Unlock Quick Slash (Q): mine at 2.5x cadence for 12 GP per swing. Mastered constellations activate immediately.",
    purchaseCopy: "Quick Slash unlocked: hold Q to trade GP for rapid mining.",
    baseCost: 0,
    goldCost: 100,
    baseEffect: 1,
  ...
  thunderStrikeAbility: {
    ...
    category: UPGRADE_CATEGORIES.SPECIAL,
    name: "Thunder Strike",
    description: "Unlock Thunder Strike (V): spend 250 GP on the opening slam, then chain up to nine free timing slams.",
    purchaseCopy: "Thunder Strike unlocked: one paid opening slam, up to nine free follow-ups.",
    baseCost: 0,
    goldCost: 250,
    baseEffect: 1,
