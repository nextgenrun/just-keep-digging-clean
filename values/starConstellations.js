...
export const STAR_CONSTELLATION_CONFIG = Object.freeze({
  ...
  collectedStarReleaseFx: Object.freeze({
    riseMinPx: 260,
    riseMaxPx: 360,
    lateralDriftMaxPx: 48,
    swayAmplitudeMinPx: 10,
    swayAmplitudeMaxPx: 24,
    swayCyclesMin: 0.65,
    swayCyclesMax: 1.05,
    durationMs: 4600,
    rarityDurationBonusMs: 220,
    liftDelayMs: 180,
    flashInMs: 170,
    settleMs: 320,
    fadeHoldMs: 2200,
    ...
    endScale: 0.68,
    maxRotationDeg: 12,
    impactFlashAlpha: 0.92,
    impactFlashStartScale: 0.42,
    impactFlashEndScale: 2.45,
    impactFlashDurationMs: 620,
    impactRingRadiusPx: 9,
    impactRingEndScale: 7.2,
    impactRingAlpha: 0.72,
    impactRingStrokePx: 2.2,
    impactRingDurationMs: 860,
    trailCount: 7,
    trailStepDelayMs: 240,
    trailRiseMinPx: 64,
    trailRiseMaxPx: 118,
    trailDriftMaxPx: 20,
    trailRadiusMinPx: 2,
    trailRadiusMaxPx: 4,
    trailAlpha: 0.82,
    trailOriginStepPx: 14,
    trailScaleFrom: 0.45,
    trailScaleTo: 1.35,
    trailDurationMs: 1520,
  }),
  chartStarSizePx: 20,
