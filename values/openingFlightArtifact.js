...
export const OPENING_FLIGHT_GOLDEN_FIVE_CONFIG = Object.freeze({
  ...
  copy: Object.freeze({
    ...
    unlockBody: "Hold {flyKey} to rise  •  {leftKey}/{rightKey} steer  •  {flyKey}+{downKey} descend",
    ...
    freeActiveBody: "{seconds}s FREE  •  {leftKey}/{rightKey} steer  •  {flyKey}+{downKey} descend",
    ...
    cacheReward: "FIRST ASCENT CACHE — +40 GP capacity, 125 M, and starter resources!",
    cacheFloatingReward: "+40 GP  •  +125 M",
