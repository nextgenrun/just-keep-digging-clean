...
const COPY = Object.freeze({
  ...
  objectiveSurface: "Follow the arrows to the marked starter shaft",
  ...
  starterChoiceLevelUp: "LEVEL {level} — starter Mining Power unlocked!",
  pickupToast: "GEM OF FLIGHT FOUND — Flight is permanently unlocked!",
  ...
  returnSuccess: "Perfect! Dig, collect resources, then use Flight to return.",
  trialComplete: "Free Flight ended — Flight now uses GP",
  gpExplainer: "GP powers flight and refills while you are not flying.",
  merchantHint: "The Gem of Great Power is buried beneath the arrows at the starter shaft.",
});
...
export const OPENING_FLIGHT_GOLDEN_FIVE_CONFIG = Object.freeze({
  ...
  copy: Object.freeze({
    ...
    phaseComplete: "OPENING COMPLETE",
    ...
    freeComplete: "Free Flight ended. Flight now uses GP; rest on the ground to refill.",
    ...
    completeTitle: "READY TO EXPLORE",
    completeBody: "DIG DEEPER  •  COLLECT RESOURCES  •  USE FLIGHT TO RETURN",
