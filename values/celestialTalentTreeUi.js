...
export const CELESTIAL_TALENT_TREE_UI_CONFIG = Object.freeze({
  ...
  copy: Object.freeze({
    ...
    subtitle: "LEVEL 3 ROOT  -  SELECT EACH LIT NODE  -  SPEND STAR POINTS  -  MASTER UPWARD",
    close: "ESC",
    owned: "OWNED",
    nodeOwned: "1/1",
    nodeLocked: "0/1",
    free: "FREE",
    inspect: "Select a lit node to spend Star Points and upgrade it. Locked nodes show their exact requirement.",
    talentsLocked: "Requires Player Level 3.",
    ...
    available: "Click or tap to upgrade.",
