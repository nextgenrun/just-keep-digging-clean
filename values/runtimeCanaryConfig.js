...
export const RUNTIME_CANARY_CONFIG = Object.freeze({
  ...
  events: Object.freeze({
    ...
    shopUiInvariant: "shop-ui-interaction-invariant",
    celestialInvariant: "celestial-engine-invariant",
    starProgressionInvariant: "star-rarity-progression-invariant",
    talentTreeInvariant: "starlight-talent-tree-invariant",
    heavenblocksInvariant: "heavenblocks-progression-invariant",
    arcCoreVisualInvariant: "arc-core-visual-invariant",
    resourceEconomyInvariant: "depth-resource-economy-invariant",
  ...
  messages: Object.freeze({
    ...
    shopUiInvariant: "Bobo shop interaction or UI is unavailable",
    celestialInvariant: "Celestial Engine safety invariant failed",
    starProgressionInvariant: "Star rarity or Sign XP safety invariant failed",
    talentTreeInvariant: "Starlight Talent Tree availability invariant failed",
    heavenblocksInvariant: "Heavenblocks progression safety invariant failed",
    arcCoreVisualInvariant: "Arc Core production visual invariant failed",
    resourceEconomyInvariant: "Depth resource economy wiring or caps failed",
