...
- spawn and the authored Golden Five shaft;
...
rows 62-64. It restores the prior cells after the protected first ascent. The
barrier is tutorial containment only and must not become a permanent town wall.

## Authored opening geography

- Golden Five shaft anchor: town x=28.
- Deterministic path: surface through artifact depth 13 m; Bedrock bottom at
  14 m; three-wide protected escape after collection.
- First Ascent Cache: five tiles to the side on the authored surface ledge.
