...
death-flow R/Enter are **SHIPPED structurally**. Pointer/browser acceptance is
still required for the new HUD hit targets.
...
The Golden Five objective HUD and world markers own the current authored
