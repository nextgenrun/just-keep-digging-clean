...
**New-list boundary:** Candidates 180–300 are not part of this implementation proposal until reviewed.
...
This hybrid mapping is intentional and must remain the source of truth for this proposal. The additional visual-only list at `markdown/2026-07-26-aaa-visual-only-candidates-201-300.md` is suggestions-only and has no implementation authority.
