...
| `2026-08-26-expanded-ground-damage-library-v4.md` | Expanded 64-motif damage library, 33 exact tile/resource profiles, optimized four-anchor mixing, WebGL evidence, validation, and full rollback chain |
...
| `2026-08-26-talent-and-depth-progression-rebalance.md` | Complete 33-node and ten-constellation talent audit, 65% live Star-rate cut, depth-biased Star value, steeper two-world material curve, 4,800m milestones, Lucky Collector repair, measurements, and rollback |
