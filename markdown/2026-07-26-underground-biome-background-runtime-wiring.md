...
|---|---:|---|
| Finished background image or V3 video | -6.4 | Scenic caves, buildings, bridges, roots and machinery |
...
- Departed non-startup images and videos are released; videos are stopped first.

## Motion-quality contract

Current motion may only move the complete finished image card:

- The V3 MP4 is a seamless 60 fps subpixel affine transform of the complete
  painting, with no optical flow, morphing, or generated in-between art.
...
- V3 video pauses under the configured 36 fps floor and resumes on recovery.
...
- `markdown/2026-07-26-underground-biome-smooth-motion-runtime-v3.md`
