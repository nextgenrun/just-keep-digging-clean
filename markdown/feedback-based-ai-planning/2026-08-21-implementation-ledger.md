...
| P1 contact-aware digging | J06-02–J06-03, J06-14–J06-16, A17-04, A17-10, A20-05–A20-09 | Implemented; runtime/video proof pending | Next slice commit | `ANIMATION_TILE_CLEARANCE_CONTRACT_OK`; authored per-clip clearance metadata, canonical tight-space fallback, legacy SIDE bridge, two distinct UP clips, moving/rooted preservation, and shared main/cave routing | `?animationClearance=0` plus slice revert |
