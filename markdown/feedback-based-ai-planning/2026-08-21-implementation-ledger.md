...
| P1 first expedition | FR-03–FR-07, FN-01–FN-17, XP-01–XP-04 | Route/safety implementation in progress; runtime and economy proof pending | Next slice commit | `FIRST_SESSION_ROUTE_CONTRACT_OK`; penalty-free local recovery, explicit abandonment loss, semantic blockers, saved funnel/assist telemetry, first-upgrade preview, and legacy onboarding contracts pass | Onboarding value rollback plus slice revert |
