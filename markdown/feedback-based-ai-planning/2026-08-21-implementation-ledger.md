...
| P2 merchant/deep presentation authority | A17-14, J03-13 | Prompt anchor and deep feature authority implemented; browser proof pending | next slice commit | `MERCHANT_PROMPT_ANCHOR_CONTRACT_OK`; prompt position is derived from the merchant ground surface with a compact-sprite compatibility clamp. Deep-world backdrop smoke and both player-light contracts pass with injected Level Two capability authority and upper-body light centering | Values/slice revert |
