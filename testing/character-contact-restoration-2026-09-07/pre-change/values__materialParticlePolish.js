...
const EARTH = response(0.78, 1.2, 0.7, 1, 1.2, 0.48);
const ROCK = response(1, 1.12, 1, 0.94, 0.95, 0.3);
const METAL = response(1.12, 1.08, 1.15, 0.9, 0.86, 0.26);
const CRYSTAL = response(1.06, 0.82, 0.72, 0.94, 1.08, 0.28);
...
export const MATERIAL_PARTICLE_POLISH = Object.freeze({
  ...
  foot: Object.freeze({
    sizeTiles: Object.freeze([0.018, 0.038]),
    scuffFrame: "p04", scuffOriginY: 0.79,
    scuffWidthTiles: 0.22, scuffStartScale: 0.76, scuffEndScale: 1.34,
    scuffDriftTiles: 0.055, scuffFadeMs: 210,
