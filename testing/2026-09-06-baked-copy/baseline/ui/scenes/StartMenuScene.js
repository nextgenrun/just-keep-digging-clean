...
export class StartMenuScene extends Phaser.Scene {
  ...
  async create() {
    ...
    this.add.text(W / 2, 226, COPY.title, {
    ...
    this.add.text(W / 2, 253, COPY.subtitle.toUpperCase(), {
    ...
    this._startPrompt = this.add.text(W / 2, SAVE_TRANSFER_UI.startMenu.startPromptY, COPY.startPrompt, {
      fontFamily: UI_FONTS.mono,
      fontSize: '16px',
      color: COL.dim,
    }).setOrigin(0.5);
    ...
    // --- Hint bar ---
    this.add.text(W / 2, SAVE_TRANSFER_UI.startMenu.hintY, COPY.controlsHint, {
      fontFamily: UI_FONTS.mono,
      fontSize: '12px',
      color: COL.hint,
    }).setOrigin(0.5);
