...
const approvedFloorCoreWidthTiles = pack.floor.approvedCoreSourceWidthPx
...
assert.ok(
  rightmostMerchant < approvedFloorCoreWidthTiles,
  "every surface merchant must stand over pixel-exact Option A ground, not its edge handoff",
);
assert.ok(
