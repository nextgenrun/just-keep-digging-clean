...
export const TILE_RENDER_INDEX = Object.freeze({
  ...
  CAVE_CEILING: STATIC_INDEX_START + 2,
  CAVE_CEILING_CHAINS: STATIC_INDEX_START + 3,
  TREASURE_STONE: STATIC_INDEX_START + 4,
  SKY_ISLAND_TOP: STATIC_INDEX_START + 5,
  CHEST: STATIC_INDEX_START + 6,
  CHEST_RARE: STATIC_INDEX_START + 7,
  TELEPORT_TILE: STATIC_INDEX_START + 8,
  GAMBLE_TILE: STATIC_INDEX_START + 9,
  FLOOR_TOWN_1: STATIC_INDEX_START + 10,
  FLOOR_TOWN_2: STATIC_INDEX_START + 11,
  GEM_POWER_BLOCK: STATIC_INDEX_START + 12,
  SPEED_BLOCK: STATIC_INDEX_START + 13,
  XP_BLOCK: STATIC_INDEX_START + 14,
  SELL_BLOCK: STATIC_INDEX_START + 15,
  CRIT_BLOCK: STATIC_INDEX_START + 16,
  BERSERK_BLOCK: STATIC_INDEX_START + 17,
  COMBO_BLOCK: STATIC_INDEX_START + 18,
  LEGEND_BLOCK: STATIC_INDEX_START + 19,
  ROOT_OVERLAY: STATIC_INDEX_START + 20,
  ROOT_OVERLAY_DEEP: STATIC_INDEX_START + 21,
  GLOW_CRYSTAL: -1,
  GEODE_INTERIOR: STATIC_INDEX_START + 22,
});
