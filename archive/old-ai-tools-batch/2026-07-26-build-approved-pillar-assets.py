...
PILLARS = {
    "milestone": {
        ...
        "approved_pixel_sha256": "6b0c172010e3b6cf5994bd1697574a147605e7e0816a586a862ffc6606ff8d0f",
    },
    "star": {
        ...
        "approved_pixel_sha256": "faebcc45c3d10d67a50115d85d225abb94b6797e54403e40f97c8222d4ce32c8",
    },
}
...
def promote_pillar(name: str, definition: dict, attachment: Path | None) -> dict:
    ...
    approved_pixel_sha256 = decoded_pixel_sha256(review_sheet)
    if approved_pixel_sha256 != definition["approved_pixel_sha256"]:
        raise ValueError(f"{name} reviewed sheet no longer matches the approved pixels")
    ...
    return {
        ...
        "approvedPixelSha256": approved_pixel_sha256,
        "approvalPixelMatchVerified": True,
