/**
 * PickaxeTrailSystem — ghost-sprite swing arc during dig animations.
 *
 * Listens to ANIMATION_UPDATE on the player sprite. While a dig animation
 * is active, spawns fading ghost copies of the current player frame to
 * create a soft motion-blur trail effect.
 */
export class PickaxeTrailSystem {
  ...
  /** Call at the start of every dig animation */
  start() {
    this._active = true;
  ...
  /** Call when the dig animation completes */
  stop() {
    this._active = false;
  }
