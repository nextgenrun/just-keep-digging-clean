...
export function createCommonShaderUniforms() {
  return {
    ...
    uTorchGlow: float(0),
    uPlayerLightVisualUpgrade: float(1),
    uTorchWarmthStrength: float(0),
    uTorchOpacityStrength: float(0),
    uTorchCoreStrength: float(0),
    uTorchBounceStrength: float(0),
    uTorchFalloffPower: float(1),
    uTorchCoreRadiusRatio: float(0.3),
    uTorchHotRadiusRatio: float(0.1),
    uTorchEdgeNoiseStrength: float(0),
    uTorchBounceOffsetRatio: float(0),
    uTorchBounceVerticalScale: float(1),
