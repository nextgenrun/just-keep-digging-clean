...
Production-approved transparent cutouts promoted from
`visual-approval-previews/npc-idle-activities-v3/`.
...
checkerboard QA sheet. Runtime behavior is disabled with `?npcActivities=0`;
anchored pacing alone is disabled with `?npcWalking=0`.
