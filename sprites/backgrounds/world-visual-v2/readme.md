...
- `far/sky-cohesion-v1/`: twenty additive, complete native-density sky cards
  at fixed world anchors; the original far plate remains continuous beneath
  their four-edge feather and between placements.
