...
`thunderstrike-chain-v1/` contains the approved mockup-derived backing art for
the live three-slam timing panel. Phaser supplies only dynamic state overlays.
